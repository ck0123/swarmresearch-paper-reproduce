...
```
- Analyst agents are also available. Rather than including "shepherd optimizer skill" or "shepherd explorer skill", specify "shepherd analyst skill" when spawning the search agent. Control them like you would an explorer agent. Add analyst findings as files to the worktrees of newly spawned explorers.
